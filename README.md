...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sqlalchemy-stubs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12734&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sqlalchemy-stubs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sqlalchemy-stubs` can be installed with:

```
conda install sqlalchemy-stubs
```

It is possible to list all of the versions of `sqlalchemy-stubs` available on your platform with:
